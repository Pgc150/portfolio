    ...
    shadow-lg'>
        ...
        <div className='conatiner mx-auto flex justify-between items-center'>
            <div>
                <a href='#' className='text-3xl font-bold text-white'>
                   Payal
                   <span className='text-purple'>Chavhan</span>
          ...
          <div className='md:hidden'>
            {
                showMenu ? 
                   <FaXmark onClick={()=> setShowMenu(!showMenu)} className='text-2xl 
                   cursor-pointer'/>
                :
                <FaBars onClick={()=> setShowMenu(!showMenu)} className='text-2xl curso-pointer'/> 
...

        {
            ...
            p-4 flex flex-col space-y-4 text-center justify-center'>
                <a href='#home' onClick={()=> setShowMenu(!showMenu)} className='relative text=white/80 transition duration-300
            hover:text-purple group'>
                <span>Home</span>
