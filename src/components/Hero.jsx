  ...
  return (
    ...
    >
        ...
        items-center justify-between'>
            <div className='md:w-1/2 mb-20 mb:mb-0'>
                 <h1 className='text-4xl md:text-6xl font-bold mb-4'>
                    Hi, I'am <span className='text-purple'>Payal Chavhan</span>
                 </h1>
                 <h2 className='text-2xl md:text-4xl font-semibold mb-6
                 typewriter'>Full Stack Developer</h2>
                 <p className='text-lg text-gray-300 mb-8'> I create stunning web experriences with modern technologies
        ...
        {/* right side image */}
         <div className='md:w-1/2 flex justify-center'>
            <div className='relative w-64 h-64 md:w-80 md:h80-'>
                <div className='absolute inset-0 rounded-full
                bg-gradient-to-r from-purple to-pink animate-pluse-slow 
                opacity-70'>
                    <motion.img 
                    animate={{y:[0,-20,0]}}
                    transition={{
